...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Koby_Botsford19',
      password: 'DgXHa6XQK_mC8cR',
      email: 'Karlie4@gmail.com',
      name: 'Orville Cole',
      shippingAddress: [
        {
          _id: false,
      ...
      userType: 460,
      mobileNo: '(042) 983-3250',
      resetPasswordLink: {},
      loginRetryLimit: 559,
      loginReactiveTime: '2024-03-25T02:04:46.256Z',
      id: '65d73354fdd00c08c437beeb'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Ellsworth_McCullough',
        'password':'AoSk6wxZbhqVMJN',
        'email':'Zita_Williamson36@gmail.com',
        'name':'Leah Schamberger',
        'shippingAddress':[{
          '_id':false,
          'pincode':'real-time',
          'address1':'Agent',
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    let user = await request(app)
      .post('/client/auth/forgot-password')
      .send({ 'email':'Zita_Williamson36@gmail.com', });
