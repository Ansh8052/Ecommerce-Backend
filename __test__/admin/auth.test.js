...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Clotilde32',
      password: 'D_MPfS1AGp1H085',
      email: 'Buford_Kozey82@hotmail.com',
      name: 'Lewis Considine III',
      shippingAddress: [
        {
          _id: false,
          pincode: 'systematic',
          address1: 'Quality-focused',
      ...
      userType: 531,
      mobileNo: '(837) 095-6674',
      resetPasswordLink: {},
      loginRetryLimit: 513,
      loginReactiveTime: '2024-11-23T21:55:46.298Z',
      id: '65d73354fdd00c08c437be13'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Geraldine.Dicki42',
        'password':'KVOZ2qTyXGiLZIf',
        'email':'Elinor_Schuster49@gmail.com',
        'name':'Maxine Wisozk',
        'shippingAddress':[{
          '_id':false,
          'pincode':'Lev',
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    let user = await request(app)
      .post('/admin/auth/forgot-password')
      .send({ 'email':'Elinor_Schuster49@gmail.com', });
